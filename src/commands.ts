...
import { startCommand, statusCommand, listCommand, pauseCommand, resumeCommand } from './ticket.command'
import { serveCommand } from './worker.command'
...
const command = Command.make('linear-ai-workflow').pipe(
  Command.withSubcommands([serveCommand, startCommand, statusCommand, listCommand, pauseCommand, resumeCommand]),
)
